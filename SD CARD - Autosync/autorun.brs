...
REM I add in sysInfo as object
...
Function ParseAutoplay(setupSync as object) as object
  ...
  REM**************************************************
  REM**************************************************
  REM******CHANGE BASE HERE******CHANGE BASE HERE******

  REM new code
  runIdObject = CreateObject("roDeviceInfo")
  baseURL$ = setupSync.LookupMetadata("client", "base") + runIdObject.GetDeviceUniqueId() + "/Presentation"

  REM original code
  REM baseURL$ = setupSync.LookupMetadata("client", "base")
